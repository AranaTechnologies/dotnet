...
End If
rst.Close
rst.Open "select * from purchase_order", cnn, adOpenStatic, adLockOptimistic, adCmdText
...
Text1.DataField = "purchase_order_no"
Text2.DataField = "vendor_id"
