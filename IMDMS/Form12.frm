...
Begin VB.Form Form12 
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H0080C0FF&
      Caption         =   "Test Report Information"
      BeginProperty Font 
...
End If
RST.Close
RST.Open "select * from Test_report", CNN, adOpenStatic, adLockOptimistic, adCmdText
...
Text2.DataField = "PATIENT_ID"
 
'ADD ITEM IN COMBOBOX'
'RST.Open "select * from TEST_REPORT", CNN, adOpenStatic, adLockOptimistic, adCmdText
While Not RST.EOF
Combo1.AddItem RST.Fields("REPORT_FILE_name")
Wend
RST.Close
Combo1.DataField = "REPORT_FILE_NAME"
