...
OUTSTREAM.WriteLine
OUTSTREAM.WriteLine
prec = Space(21) & "DUTY ALLOTMENT"
OUTSTREAM.WriteLine prec
prec = "*********************************************************************************"
OUTSTREAM.WriteLine prec
prec = Space(5) & "To,"
OUTSTREAM.WriteLine prec
prec = Space(5) & RST.Fields("EMPLOYEE_NAME")
OUTSTREAM.WriteLine prec
OUTSTREAM.WriteLine
OUTSTREAM.WriteLine
...
RST.Open "select E.EMPLOYEE_ID, E.EMPLOYEE_NAME, D.DEPARTMENT_NAME, D.DATE_OF_DUTY, D.DUTY_HOURS, D.COMMENTS from DUTY_ROSTER_FILE D, EMPLOYEE_FILE E where (RTRIM(E.EMPLOYEE_ID)) = (RTRIM(D.EMPLOYEE_ID))", CNN, adOpenStatic, adLockOptimistic, adCmdText
