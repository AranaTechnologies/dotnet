...
temp = RST1.Fields("SUPPLIER_ID")
sql = "UPDATE GENERATED_LAST SET SUPPLIER_ID=SUPPLIER_ID+1"
Set RST1 = CNN.Execute(sql)
temp = Trim(temp)
temp1 = "SUPPLIER" & temp
RST.Fields("SUPPLIER_ID") = temp1
End Sub
...
End If
RST.Close
RST.Open "select * from SUPPLIER_FILE", CNN, adOpenStatic, adLockOptimistic, adCmdText
